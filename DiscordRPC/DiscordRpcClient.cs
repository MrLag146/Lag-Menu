using Lagmenu.DiscordRPC.Events;
using Lagmenu.DiscordRPC.Exceptions;
using Lagmenu.DiscordRPC.IO;
using Lagmenu.DiscordRPC.Logging;
using Lagmenu.DiscordRPC.Message;
using Lagmenu.DiscordRPC.RPC;
using Lagmenu.DiscordRPC.RPC.Commands;
using System;

namespace Lagmenu.DiscordRPC
{
